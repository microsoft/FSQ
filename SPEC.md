...
| providers | fsq_agent/providers/SPEC.md | Owns OpenAI/Azure/DeepSeek/Gemini/Copilot supplier authentication, token and model-selection policy, connection testing, and configured neutral model access. |
