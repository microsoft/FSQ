...
- AgentTool request/result models are serializable and SDK-neutral. Tools expose neutral `agent_engine` bindings; the private engine owns SDK tool conversion. Shared business models do not import SDK or engine runtime objects.
