    ...
    def _handle_config_write(
        ...
        *,
        ...
        try:
            ...
            if method == "POST" and path == f"{_API_PREFIX}/config/deepseek/models":
                return 200, list_deepseek_config_models(body)
            ...
            if method == "PUT" and path == f"{_API_PREFIX}/config/deepseek":
                return 200, save_deepseek_config(body, self.options.user_config_root)
