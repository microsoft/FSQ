...
- Platform action schemas are not configured through external tool servers. They are declared by decorated capability hosts, validated in the capability registry, and exposed as neutral agent-engine tool bindings. The private engine backend constructs SDK tools.
